# Lab 6 Supplement: Terraform Console Operations
...
Strengthen normal Terraform expression operations for exam preparation. Use only `terraform console` to inspect and transform the locals in `console.tf`. No cloud resources are created.

## Getting Started

From this directory, prepare the configuration and open the console:
